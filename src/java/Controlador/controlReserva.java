...
public class controlReserva extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String valor, pagina ="";
        BDmesa obj = new BDmesa();
        ArrayList<mesa>list = new ArrayList<>();
        
        valor = request.getParameter("accion");
        
        if(valor.equalsIgnoreCase("Agregar reserva")){
            list = obj.listar();
            request.setAttribute("listaMesas", list);
            pagina = "/reserva.jsp";
        }
